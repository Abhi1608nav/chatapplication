          ...
          </div>
{
    searchedContacts.length>0 &&
                ...
                return (
                  ...
                  >
                    <div className="w-12 h-12 relative ">
                      <Avatar className=" h-12 w-12  rounded-full overflow-hidden ">
                        {contact.image ? (
                          ...
                          >
                            {contact.firstName
                              ? contact.firstName.trim().split("").shift()
                              : contact.email.trim().split("").shift()}
                          </div>
                        )}
                      </Avatar>
                    </div>
                    <div className="flex gap-5">
                      ...
                      {/* <span className="text-xm">{contact.email}</span> */}
                    </div>
                  </div>
                );
              })}
          ...
          {searchedContacts.length <= 0 && (
            <div className="flex-1 md:bg-[#1c1d25] md:flex md:mt-0 mt-5 flex-col justify-center items-center  duration-1000 transition-all ">
              <Lottie
