...
const MessageBar = () => {
  ...
  return (
    <div className="h-[10vh] bg-[#1c1d25] flex items-center justify-center px-8 mb-6 gap-6">
        ...
        <button className=' bg-[#8417ff] rounded-md flex items-center justify-center p-5 focus:border-none hover:bg-[#6615c2] focus:bg-[#741bda] focus:outline-none focus:text-white duration-300  transition-all' 
